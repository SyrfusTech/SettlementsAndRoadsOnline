...
public class ClientSend : MonoBehaviour
{
    ...
    // UDPTest Received packet that we can send to Server
    public static void UDPTestReceived()
    {
        // As always add the ClientPackets.udpTestReceived enum to the start of the packet so that we know what kind of packet has just arrived on Server side
